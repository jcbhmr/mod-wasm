...
var Exports struct {
	...
	InvalidPathError struct {
		...
		//
		//	get-err: func() -> option<error>
		GetErr func(self cm.Rep) (result cm.Option[Error])
		...
		//
		//	unwrap: func() -> option<error>
		Unwrap func(self cm.Rep) (result cm.Option[Error])
	}
	...
	//
	//	check: func(path: string, version: string) -> option<error>
	Check func(path string, version string) (result cm.Option[Error])

	// CheckFilePath represents the caller-defined, exported function "check-file-path".
	//
	//	check-file-path: func(path: string) -> option<error>
	CheckFilePath func(path string) (result cm.Option[Error])

	// CheckImportPath represents the caller-defined, exported function "check-import-path".
	//
	//	check-import-path: func(path: string) -> option<error>
	CheckImportPath func(path string) (result cm.Option[Error])

	// CheckPath represents the caller-defined, exported function "check-path".
	//
	//	check-path: func(path: string) -> option<error>
	CheckPath func(path string) (result cm.Option[Error])

	// CheckPathMajor represents the caller-defined, exported function "check-path-major".
	//
	//	check-path-major: func(v: string, path-major: string) -> option<error>
	CheckPathMajor func(v string, pathMajor string) (result cm.Option[Error])
