...
func wasmexport_InvalidPathErrorGetErr(self0 uint32) (result *cm.Option[Error]) {
	self := cm.Reinterpret[cm.Rep]((uint32)(self0))
...
func wasmexport_InvalidPathErrorUnwrap(self0 uint32) (result *cm.Option[Error]) {
	self := cm.Reinterpret[cm.Rep]((uint32)(self0))
...
func wasmexport_InvalidVersionErrorGetErr(self0 uint32) (result *cm.Option[Error]) {
	self := cm.Reinterpret[cm.Rep]((uint32)(self0))
...
func wasmexport_InvalidVersionErrorUnwrap(self0 uint32) (result *cm.Option[Error]) {
	self := cm.Reinterpret[cm.Rep]((uint32)(self0))
...
func wasmexport_ModuleErrorGetErr(self0 uint32) (result *cm.Option[Error]) {
	self := cm.Reinterpret[cm.Rep]((uint32)(self0))
...
func wasmexport_ModuleErrorUnwrap(self0 uint32) (result *cm.Option[Error]) {
	self := cm.Reinterpret[cm.Rep]((uint32)(self0))
...
func wasmexport_Check(path0 *uint8, path1 uint32, version0 *uint8, version1 uint32) (result *cm.Option[Error]) {
...
func wasmexport_CheckFilePath(path0 *uint8, path1 uint32) (result *cm.Option[Error]) {
	path := cm.LiftString[string]((*uint8)(path0), (uint32)(path1))
...
func wasmexport_CheckImportPath(path0 *uint8, path1 uint32) (result *cm.Option[Error]) {
	path := cm.LiftString[string]((*uint8)(path0), (uint32)(path1))
...
func wasmexport_CheckPath(path0 *uint8, path1 uint32) (result *cm.Option[Error]) {
	path := cm.LiftString[string]((*uint8)(path0), (uint32)(path1))
...
func wasmexport_CheckPathMajor(v0 *uint8, v1 uint32, pathMajor0 *uint8, pathMajor1 uint32) (result *cm.Option[Error]) {
	v := cm.LiftString[string]((*uint8)(v0), (uint32)(v1))
