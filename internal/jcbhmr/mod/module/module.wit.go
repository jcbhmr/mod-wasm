...
// Error represents the string "jcbhmr:mod/module@0.36.0#error".
//
//	type error = string
type Error string

// InvalidPathError represents the exported resource "jcbhmr:mod/module@0.36.0#invalid-path-error".
//
...
// InvalidVersionError represents the exported resource "jcbhmr:mod/module@0.36.0#invalid-version-error".
//
...
// ModuleError represents the exported resource "jcbhmr:mod/module@0.36.0#module-error".
//
